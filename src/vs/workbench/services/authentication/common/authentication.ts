...
export interface IAuthenticationCreateSessionOptions {
	 ...
	 * Authorization Grant (ID-JAG, RFC 8693) flows where the audience identifies the authorization server of the resource that
...
export interface IAuthenticationService {
	 ...
	 *
	 * @param issuer The OAuth/OIDC issuer URL (typically read from `mcp.enterpriseManagedAuth.issuer`).
	 */
